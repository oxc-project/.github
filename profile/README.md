...
| [oxc-vscode](https://github.com/oxc-project/oxc-vscode) | Oxc VS Code Extension | [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=oxc.oxc-vscode) |
| [oxc-intellij-plugin](https://github.com/oxc-project/oxc-intellij-plugin) | Oxc IntelliJ Plugin | [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/27061-oxc) |
| [coc-oxc](https://github.com/oxc-project/coc-oxc) | Oxc extension for coc.nvim | [![NPM Downloads](https://img.shields.io/npm/dw/coc-oxc?label=coc-oxc)](https://npmx.dev/package/coc-oxc) |
| [oxc-zed](https://github.com/oxc-project/oxc-zed) | Oxc extension for Zed | [Zed Extensions](https://zed.dev/extensions/oxc) |
| [website](https://github.com/oxc-project/website) | Oxc documentation and project site | [oxc.rs](https://oxc.rs) |
| [playground](https://github.com/oxc-project/playground) | Online Oxc playground | [playground.oxc.rs](https://playground.oxc.rs) |
| [oxlint-action](https://github.com/oxc-project/oxlint-action) | GitHub Actions task to run Oxlint | [Action](https://github.com/oxc-project/oxlint-action) |
...
| [oxc-toml](https://github.com/oxc-project/oxc-toml) | Taplo forked for Oxfmt | [crates.io](https://crates.io/crates/oxc-toml) |
